...
class INSPhotosInteractionAnimator: NSObject, UIViewControllerInteractiveTransitioning {
    ...
    fileprivate func fixCancellationStatusBarAppearanceBug() {
    ...
    fileprivate func isRadar20070670Fixed() -> Bool {
    ...
    fileprivate func backgroundAlphaForPanningWithVerticalDelta(_ delta: CGFloat) -> CGFloat {
        guard let fromView = transitionContext?.view(forKey: UITransitionContextViewKey.from) else {
            return 0.0
        }
